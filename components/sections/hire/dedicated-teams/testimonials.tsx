...
export function Testimonials() {
  const testimonials = [
    {
      quote: "Avaantra's dedicated team became our remote tech department — we scale at will.",
      author: "CTO",
      company: "SaaS Platform (Singapore)",
      rating: 5,
    },
    {
      quote: "It's like having an in-house team without the hiring pain. Highly professional.",
      author: "Founder",
